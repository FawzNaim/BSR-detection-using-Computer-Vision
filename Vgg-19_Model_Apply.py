...
if __name__ == "__main__":
    IMAGE_PATH = r"/content/BSR-detection-using-Computer-Vision/Bonaventure_BSR3.png"
    GT_MASK    = r"/content/BSR-detection-using-Computer-Vision/Bonaventure_BSR3.png"
