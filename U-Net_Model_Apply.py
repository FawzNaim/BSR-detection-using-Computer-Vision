...
if __name__ == "__main__":
    ...
    run_unet_inference(
        image_path=r"/content/BSR-detection-using-Computer-Vision/BSR_extra_validation2.png",
        mask_path=r"/content/BSR-detection-using-Computer-Vision/BSR_extra_validation2.png",
